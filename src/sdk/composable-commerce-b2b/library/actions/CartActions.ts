...
export const getCartActions = (sdk: SDK<ComposableCommerceEventsB2B>): CartActions => {
  return {
    getCart: async (query?: GetCartQuery, options?: { serverOptions?: ServerOptions }) => {
    ...
    replicateOrder: async (query?: ReplicateOrderQuery, options?: { serverOptions?: ServerOptions }) => {
      const response = await sdk.callAction<Cart>({
