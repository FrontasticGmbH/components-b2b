...
type Props = {
  open: boolean;
  deleteBusinessUnit: (businessUnitKey: string) => Promise<void>;
  businessUnit: BusinessUnit;
  onClose: () => void;
};

const DeleteBusinessUnit: React.FC<Props> = ({ open, deleteBusinessUnit, businessUnit, onClose }) => {
  ...
  const handleDeleteBusinessUnit = async () => {
    setIsLoading(true);
    await deleteBusinessUnit(businessUnit.key);
    setIsLoading(false);
    onClose();
  };
                ...
                >
                  ...
                  <div className="relative mx-auto max-w-xl">
                    ...
                    <div className="flex flex-row justify-between">
                      ...
                      <button className="button button-primary" onClick={handleDeleteBusinessUnit}>
